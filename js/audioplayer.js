const tracks = [
    ...
    { file: "track22.mp3", title: "Lay All Your Love On Me", author: "ABBA" },
    { file: "track23.mp3", title: "Intro", author: "The xx" },
    { file: "track24.mp3", title: "The Falling Mysts", author: "Dimrain47" },
    { file: "track25.mp3", title: "Children (Dream Version)", author: "Robert Miles" },
    { file: "track26.mp3", title: "Precipice", author: "Aaron Cherof" },
];
...
const colorConfig = {
    specialTracks: [10, 11, 12, 13, 14, 19, 21, 24, 25],
    targetClasses: {
...
playPauseButton.addEventListener('click', () => {
    if (audioElement.paused) {
        ...
        audioElement.pause();
        playPauseIcon.src = 'assets/player/play_arrow.svg';
    }
});
